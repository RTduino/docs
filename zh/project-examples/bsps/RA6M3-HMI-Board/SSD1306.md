...
```bash
download link: https://github.com/RT-Thread-Studio/sdk-debugger-pyocd/archive/refs/tags/0.2.1.zip
```

注意，这里下载的是0.2.1版本，下载完请确认一下。
...
```json
{
    ...
    "configurations": [
        {
            "name": "Cortex Debug",
            "cwd": "C:/Users/RTT/Downloads/sdk-debugger-pyocd-0.2.1",
            "executable": "${workspaceFolder}/bsp/renesas/ra6m3-hmi-board/rtthread.elf",
            "request": "launch",
            "type": "cortex-debug",
            "runToEntryPoint": "main",
            "targetId": "R7FA6M3AH",
            "servertype": "pyocd",
            "serverpath": "C:/Users/RTT/Downloads/sdk-debugger-pyocd-0.2.1/pyocd.exe",
            "armToolchainPath": "D:/GCC/gcc-arm-none-eabi-10-2020-q4-major-win32/bin",
            "gdbPath": "D:/GCC/gcc-arm-none-eabi-10-2020-q4-major-win32/bin/arm-none-eabi-gdb.exe",
        },
    ]
}
```
...
*   `cwd`：修改为`sdk-debugger-pyocd`的源路径
*   `serverpath`：这部分路径在前面所安装的 `sdk-debugger-pyocd`里的`pyocd.exe`位置
